...
passport.use(
  new GoogleStrategy(
    {
      clientID:
        "948522409811-l4kshn91lsuqtk220rfo8i4mrpi3951v.apps.googleusercontent.com",
      clientSecret: "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",
        ...
        .findOne(
          ...
          (err, result) => {
            ...
            if (result) {
              ...
              mongo.db.collection("users").insert(newUser, (err, result) => {
...
function register(req, username, password, done) {
  ...
  if (password !== req.body.password2) {
    ...
    return done(null, false, {
      message: "Username cannot be longer than twenty characters.",
    });
